...
var gulp = require('gulp'),
	...
	*/
	var srcPath={		
		'scss': './webpack_sass_gulp/_dev/devsass',	
		'publik': './webpack_sass_gulp/public',
        'devjs':'./webpack_sass_gulp/_dev/devjs',
		'configjs':'./webpack_sass_gulp/config'
	}
...
gulp.task('webpackjs', function() {
    ...
    .pipe(webpack( require(srcPath.configjs +'/webpack.config.js') ))
...
gulp.task('default',function() {
	...
	gulp.watch(srcPath.devjs +'/**/*.js', ['webpackjs']);       
