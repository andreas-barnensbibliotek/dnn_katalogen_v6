' Copyright (c) 2016  Andreas Josefsson
'  All rights reserved.
' 
...
''' 
''' Because the control inherits from DNN_katalogen_v6SettingsBase you have access to any custom properties
''' defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
''' </summary>
''' -----------------------------------------------------------------------------
Public Class Settings
    Inherits DNN_katalogen_v6SettingsBase
